...
function Cart() {
  ...
  if (!token || !userId) {
    return (
      <p className="text-center p-8">من فضلك قم بتسجيل الدخول لرؤية السلة</p>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto py-10 px-4">
        <h1 className="text-2xl font-bold mb-6 text-right">سلة المشتريات</h1>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="flex-1 text-right">
                ...
                <p className="text-sm text-gray-500">السعر: {item.price} ج.م</p>
              </div>

              <div className="flex items-center gap-2">
                <button
                  onClick={() =>
                    handleChangeQty(item.product_id, item.quantity - 1)
                  }
                ...
                <button
                  onClick={() => handleDeleteItem(item.product_id, item.quantity)}
